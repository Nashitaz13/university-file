...
namespace XNA_RPG_textMapEditor.Helper
{
    class AssetPath
    {
        public static string PlayerTexture = "Texture/Sprite/Player/";
        public static string EnemyTexture = "Texture/Sprite/Enemy/";
        public static string TileTexture = "Texture/Tile/";
        public static string Map = "Content/Level/";
        public static string ButtonTexture = "GUI/Button/";
        public static string OverlayTexture = "Texture/Overlay/";
