...
namespace QuanLySieuThiDienThoai.GUI
{
    public partial class MatHang : UserControl
    {
        ...
        private void backstageViewTabItem_nhacc_SelectedChanged(object sender, DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs e)
        {
        ...
        private void backstageViewTabItem_gia_SelectedChanged(object sender, DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs e)
        {
