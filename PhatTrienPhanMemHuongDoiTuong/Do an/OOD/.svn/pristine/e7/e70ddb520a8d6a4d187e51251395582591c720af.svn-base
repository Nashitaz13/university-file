...
{
    public partial class BaoCaoDoanhSoNhapHang : UserControl
    {
        public static DateTime NgayBatDau, NgayKetThuc;
        public static decimal Thang, Nam;
        public static int Choose;
        public BaoCaoDoanhSoNhapHang()
        {
            InitializeComponent();
        }
        ...
        private void BaoCaoDoanhSoNhapHang_Load(object sender, EventArgs e)
        {
        ...
        {
            nAM_NHAPTableAdapter.Fill(qLCHDTdataset.NAM_NHAP);
            tHANG_NHAPTableAdapter.Fill(qLCHDTdataset.THANG_NHAP);
