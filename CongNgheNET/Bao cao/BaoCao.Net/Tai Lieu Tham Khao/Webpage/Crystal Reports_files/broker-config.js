...
{m:"//msdn.microsoft.com/en-us",c:"inv_c_p246609455.js",f:0.0209,p:0}
,{m:"technet.microsoft.com/en-us",c:"inv_c_p246609455-technet.js",f:0.0436,p:0}
,{m:"enterprise.microsoft.com/en-us",c:"inv_c_p346498099-en-us.js",f:0.1,p:0}
...
if(/windowsmediaplayer|(microsoft|microsoftbusinesshub|xbox|windowsphone|windows|skype|live|microsoftvirtualacademy|microsoftvolumelicensing|microsoftstore|office|onenote|visualstudio)\.com/i.test(document.referrer)){
	COMSCORE.SiteRecruit._halt = true;
}
//Mobile
if (/enterprise\.microsoft\.com/i.test(window.location)) {
